...
const HEADING = "Game to win with smooth performance";
const BODY =
  "Have a great gaming experience with up to 60Hz VRR. With the first ever BT ULL certified controller paired with fast refresh rates, every gaming moment becomes more enjoyable.";
...
export default function GamingStorySection() {
  return (
    ...
    <div className="-mx-6 flex flex-col bg-black md:-mx-10 lg:-mx-16">
      ...
      >
        <Image
          src="/images/product 1/gaming.png"
